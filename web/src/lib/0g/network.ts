...
export function getNetworkConfig(networkType: NetworkType): NetworkConfig {
  const configs = {
    standard: {
      ...
      storageRpc: import.meta.env.VITE_STANDARD_STORAGE_RPC || 'https://indexer-storage-mainnet.0g.ai',
      l1Rpc: import.meta.env.VITE_STANDARD_L1_RPC || 'https://evmrpc-mainnet.0g.ai',
    ...
    turbo: {
      ...
      storageRpc: import.meta.env.VITE_TURBO_STORAGE_RPC || 'https://indexer-storage-turbo-mainnet.0g.ai',
      l1Rpc: import.meta.env.VITE_TURBO_L1_RPC || 'https://evmrpc-mainnet.0g.ai',
