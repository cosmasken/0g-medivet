...
// Rate limiter for compute-intensive operations
const computeLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: 20, // Limit each IP to 20 compute requests per windowMs
  message: {
    error: 'Too many compute requests from this IP, please try again later.',
