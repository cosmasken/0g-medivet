...
class HealthConnectManager(private val context: Context) {
   ...
   */
  suspend fun syncHealthDataToBackend(userId: String, start: Instant, end: Instant): Boolean {
    return try {
   ...
   */
  private suspend fun readCaloriesData(start: Instant, end: Instant): List<TotalCaloriesBurnedRecord> {
    val request = ReadRecordsRequest(
   ...
   */
  private suspend fun readExerciseData(start: Instant, end: Instant): List<ExerciseSessionRecord> {
    val request = ReadRecordsRequest(
      recordType = ExerciseSessionRecord::class,
      timeRangeFilter = TimeRangeFilter.between(start, end)
    )
